...
public class AiSummarizationService {
  ...
  private static final String FINAL_SYSTEM_PROMPT =
      "You are a news summarization assistant. Summarize the provided news articles from the last"
          ...
          + " low-importance items. Write in the same language as the articles. Keep it concise but"
          + " informative.\n\n"
          ...
          + "Always organize the digest into exactly these categories in this order:\n"
          + "### International\n"
          + "### National\n"
          + "### Politik\n"
          + "### Wirtschaft\n"
          ...
          + "### Computertechnik\n"
          + "### Kurioses\n"
          + "Omit a category only if there are no articles for it. Place each article in the single"
          ...
          + "For the ### Kurioses section: pick the most unusual, surprising, or quirky story of"
          + " the day — something that stands out as a curiosity. Present it with a fun, light"
          + " tone. If no article qualifies as truly unusual, pick the most unexpected or"
          + " entertaining one.";
