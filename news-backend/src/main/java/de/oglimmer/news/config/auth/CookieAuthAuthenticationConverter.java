...
/**
 * this is an adoption of org.springframework.security.web.authentication.www.BasicAuthenticationConverter
 */
@Setter
public class CookieAuthAuthenticationConverter implements AuthenticationConverter {
    ...
    public UsernamePasswordAuthenticationToken convert(HttpServletRequest request) {
        ...
        String requestParameter = Arrays.stream(request.getCookies())
        ...
        List<GrantedAuthority> authorities = List.of(new SimpleGrantedAuthority("ROLE_USER"), new SimpleGrantedAuthority("ROLE_ANONYMOUS"));
        UsernamePasswordAuthenticationToken result = UsernamePasswordAuthenticationToken.authenticated(email, authToken, authorities);
