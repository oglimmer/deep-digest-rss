...
//    }
    ...
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http/*, RememberMeServices rememberMeServices, UserService userService*/) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .requestMatchers(POST, "/api/v1/feed").hasRole("ADMIN")
                                .requestMatchers("/api/v1/feed-item-to-process").hasRole("ADMIN")
