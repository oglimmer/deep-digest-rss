 ...
 * @param <B>
 */
public final class CookieAuthConfigurer<B extends HttpSecurityBuilder<B>> extends AbstractHttpConfigurer<CookieAuthConfigurer<B>, B> {
    ...
    public CookieAuthConfigurer() {
        this.authenticationEntryPoint = new HttpStatusEntryPoint(HttpStatus.UNAUTHORIZED);
    }


    public CookieAuthConfigurer<B> authenticationEntryPoint(AuthenticationEntryPoint authenticationEntryPoint) {
        this.authenticationEntryPoint = authenticationEntryPoint;
        return this;
    }

    public CookieAuthConfigurer<B> authenticationDetailsSource(
    ...
    public CookieAuthConfigurer<B> securityContextRepository(SecurityContextRepository securityContextRepository) {
        this.securityContextRepository = securityContextRepository;
        return this;
    }

    public CookieAuthConfigurer<B> userService(UserService userService) {
    ...
    public void configure(B http) {
        ...
        CookieAuthFilter queryParamAuthFilter = new CookieAuthFilter(authenticationManager, userService, this.authenticationEntryPoint);
