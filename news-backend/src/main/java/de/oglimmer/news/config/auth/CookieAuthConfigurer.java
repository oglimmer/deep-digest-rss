 ...
 * @param <B>
 */
public final class CookieAuthConfigurer<B extends HttpSecurityBuilder<B>>
    extends AbstractHttpConfigurer<CookieAuthConfigurer<B>, B> {
  ...
  public CookieAuthConfigurer<B> authenticationEntryPoint(
  ...
  public CookieAuthConfigurer<B> securityContextRepository(
  ...
  private void registerDefaults(B http) {
    ...
    RequestMatcher preferredMatcher =
        new OrRequestMatcher(Arrays.asList(restNotHtmlMatcher, allMatcher));
  ...
  public void configure(B http) {
    ...
    CookieAuthFilter queryParamAuthFilter =
        new CookieAuthFilter(authenticationManager, userService, this.authenticationEntryPoint);
