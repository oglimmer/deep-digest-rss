 ...
 * @param <B>
 */
public final class QueryParamAuthConfigurer<B extends HttpSecurityBuilder<B>>
    extends AbstractHttpConfigurer<QueryParamAuthConfigurer<B>, B> {
  ...
  public QueryParamAuthConfigurer<B> authenticationEntryPoint(
  ...
  public QueryParamAuthConfigurer<B> securityContextRepository(
  ...
  public void configure(B http) {
    ...
    QueryParamAuthFilter queryParamAuthFilter =
        new QueryParamAuthFilter(authenticationManager, this.authenticationEntryPoint);
